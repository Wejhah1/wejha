...
function FormSection({
  ...
  return (
    <section className="flex flex-col gap-4 rounded-2xl border border-border/60 p-5 sm:p-6">
  ...
  return (
    <form action={action} className="flex max-w-3xl flex-col gap-5">
      ...
      <FormSection title="الصور">
        <ImageUploadField name="cover_image_url" label="صورة الغلاف" defaultValue={location?.cover_image_url} />
        <GalleryUploadField
          name="gallery_urls"
          label="معرض الصور"
          defaultUrls={location?.gallery_urls}
        />
      </FormSection>

      <FormSection title="حقائق قصيرة">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-2">
            <Label htmlFor="facts_ar">سطر لكل حقيقة (عربي)</Label>
            <Textarea
              id="facts_ar"
              name="facts_ar"
              rows={5}
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="facts_en">One per line (English)</Label>
            <Textarea
              id="facts_en"
              name="facts_en"
              rows={5}
      ...
      <FormSection title="التواصل والنشر">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-2">
            <Label htmlFor="whatsapp_number">رقم واتساب (مع رمز الدولة)</Label>
            <Input
              id="whatsapp_number"
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="whatsapp_contact_name">اسم جهة التواصل (اختياري)</Label>
            <Input
